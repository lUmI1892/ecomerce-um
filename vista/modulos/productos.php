...
<?php 
	...
	if ($banner != null) {
		...
		<div class="textBanner '.$banner["estilo"].'">
...
<?php 
	...
	/*=============================================
	LLAMADO A CATEGORIAS-SUBCATEGORIAS-Y-DESSTACADOS
	=============================================*/
	...
	}else if($rutas[0] == "articulos-gratis"){
					...
					echo '</ul>
						...
						<ul class="list0"  style="display: none;">';
							...
							echo '<li class="col-xs-12">
								...
								<div class="col-lg-2 col-md3 col-sm-4 col-xs-12">
									<figure>
								...
								<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
									...
									echo '<div class="btn-group pull-left enlaces">
										...
										<button class="btn btn-default btn-xs deseos" idProducto="'.$value["id"].'" data-toggle="tooltip" title="Agregar a mi lista de deseos">
				...
				<?php 
					...
					if (count($listaProductos) != 0) {
						...
						if ($pagProductos > 4) {
							...
							/*=============================================
							LOS BOTONES DE LAS PRIMERAS 4 PAGUINAS Y LA ULTIMA PAGUINA
							=============================================*/
							...
							=============================================*/
								...
								<li id="item'.$pagProductos.'"><a href="'.$url.$rutas[0].'/'.$pagProductos.'">'.$pagProductos.'</a></li>
								<li><a href="'.$url.$rutas[0].'/'.($numPagActual + 1).'"><i class="fa fa-angle-right"></i></a></li>';

							}

							/*=============================================
							LOS BOTONES DE LA MITAD DE PAGINAS HACIA ARRIVA
							=============================================*/
							...
							/*=============================================
							LOS BOTONES DE LAS ULTIMAS 4 PAGUINAS Y LA PRIMERA PAGUINA
							=============================================*/

							$numPagActual = $rutas[1];

								echo ' <ul class="pagination">
										<li><a href="'.$url.$rutas[0].'/'.($numPagActual-1).'"><i class="fa fa-angle-left"></i></a></li>
