...
<div class="container-fluid" id="slide">
	<div class="row">
		...
		<ul>
			...
			======================================-->
			<li>
				<img src="http://localhost/backend/vista/img/slide/default/back_default.jpg">
			...
			======================================-->
			<li>
				<img src="http://localhost/backend/vista/img/slide/slide3/fondo2.jpg">

				<div class="slideOpciones slideOpcion2">

					<img class="imgProducto" src="http://localhost/backend/vistas/img/slide/slide3/iphone.png" style="top:5%; right: 15%;width: 25%">
